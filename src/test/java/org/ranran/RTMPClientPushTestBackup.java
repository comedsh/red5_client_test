 ...
 *
 */
public class RTMPClientPushTestBackup extends RTMPClient implements INetStreamEventHandler, IPendingServiceCallback, IEventDispatcher {  
	...
	private static final Logger logger = LoggerFactory.getLogger(RTMPClientPushTestBackup.class); 
	...
	public RTMPClientPushTestBackup() {
	...
	void collectMP4(){
		...
		try {
            ...
            while( stream.hasMore() ){
            	...
            	if( frameBuffer.size() < RTMPClientPushTestBackup.FRAME_BUFFER_THREDHOLE ){
			...
			RTMPClientPushTestBackup.frameCollectedCompleted = true;
	...
	void collectMp4Reference(){
		...
		try {
			...
			while( reader.hasMoreTags() ){
				...
				TimeUnit.MILLISECONDS.sleep( RTMPClientPushTestBackup.FRAME_MILLISECONDS_INTERVAL );
