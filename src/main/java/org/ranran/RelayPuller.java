...
public class RelayPuller extends RTMPClient{
    ...
    private String application = "my-first-red5-example"; //oflaDemo

    private String filename = "mystream"; //"Avengers2.mp4";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final RelayPuller player = new RelayPuller();
...
//            	if( headerDataType == Constants.TYPE_VIDEO_DATA ){ 
//            		
//            		IoBuffer buf = ((IStreamData<?>) message.getBody()).getData().asReadOnlyBuffer();
//
//            		buf.rewind();
//            		
...
//            		
//            		VideoData video = ( (VideoData) message.getBody() );
//            		
//            		video.setData( data );
//            		
...
//            	}
	            ...
	            // cache those frames that needs to be relay push.
    ...
    private IPendingServiceCallback createStreamCallback = new IPendingServiceCallback() {
        ...
        public void resultReceived(IPendingServiceCall call) {
            ...
            if (live) {
                ...
                // 这里是发送 play 指令给服务器，要求服务器开始返回流数据
